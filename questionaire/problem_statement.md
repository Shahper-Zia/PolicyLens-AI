...
1. **Notebook(s) / codebase** - Full pipeline from PDF ingestion to structured output. All intermediate and final outputs must be visible. Code should be clean, commented, and **reproducible**.
1. **(Optional) Dashboard or visual assets** - Screenshots or a hosted link to any interactive visualization of the extracted data.
#
#
# **Technical Guidance** 

## **Tools & Resources**
- For setup, we recommend using open-source LLMs, **with Gemini 2.5 model with free API access (up to 1500 API calls per day) in a Kaggle / Google Colab Notebook (free tier options)** as a practical starting point.
...
|**Milestone**|**Date**|
| :-: | :-: |
|**Problem Statement & Data Release**|22<sup>nd</sup> May’26|
|**Submission Deadline**|1<sup>st</sup> June’26 9AM IST|
