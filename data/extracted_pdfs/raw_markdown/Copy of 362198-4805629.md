...
9. iv . New appearance or worsening of pustules.
...
19. iv . A HAP preferred biologic (e.g., infliximab, adalimumab)
...
11. iv . Tofacitinib (Xeljanz) – Specific Prior Authorization coverage applies. Refer to Pharmacy Care Management HAP Criteria for Use of Drugs Document.
...
- iii. Rituximab
6. iv . Sarilumab
7. v . For Golimumab: Member must continue weekly methotrexate.
...
4. iv . For Secukinumab: Member must fail a therapeutic trial of all HAP preferred anti-TNF agents of at least 4 months duration or have intolerable side effects or contraindications to treatment with anti-TNF agents.
...
- i. For members who are unable to tolerate higher doses of colchicine with once-daily dosing due to side effects, a divided dosing regimen (twice daily) has been trialed
- b. For members with accompanied chronic arthritis, colchicine in combination with ONE immunomodulator (e.g., methotrexate, azathioprine, sulfasalazine) for at least 3 months
- c. Colchicine in combination with all HAP preferred anti-TNF medications at maximum doses for at least 3 months d. Anakinra
...
- ii. Glucocorticosteroids (prednisone 10-30 mg once daily) for at least 2-months
- iii. At least 3-month trial of ONE DMARDs such as methotrexate, cyclosporine, or leflunomide;
5. iv . At least 3-month trial of all HAP preferred anti-TNF inhibitors
...
7. iv . At least 3-month trial of the following HAP preferred biologics:
...
- ii. Glucocorticosteroids (prednisone 10-30 mg once daily) for at least 2-months
- iii. At least 3-month trial of ONE DMARDs such as methotrexate, cyclosporine, leflunomide;
6. iv . At least 3-mont trial of ALL HAP preferred biologics at maximum doses:
...
| American College of Rheumatology Scores (ACR)                                                                                               | Improvement is denoted as either ACR 20, ACR 50 or ACR 70 reflecting either an improvement to the 20%, 50%, or 70% level in the parameters outlined (see section 2.a) under LIMITATIONS)                                                                                                                                                                                                                                                                 | Improvement is denoted as either ACR 20, ACR 50 or ACR 70 reflecting either an improvement to the 20%, 50%, or 70% level in the parameters outlined (see section 2.a) under LIMITATIONS)                                                                                                                                                                                                                                                                 | Improvement is denoted as either ACR 20, ACR 50 or ACR 70 reflecting either an improvement to the 20%, 50%, or 70% level in the parameters outlined (see section 2.a) under LIMITATIONS)                                                                                                                                                                                                                                                                 | Improvement is denoted as either ACR 20, ACR 50 or ACR 70 reflecting either an improvement to the 20%, 50%, or 70% level in the parameters outlined (see section 2.a) under LIMITATIONS)                                                                                                                                                                                                                                                                 |
...
| Health Assessment Questionnaire for the                                                                                           | Responses are 0 = able to do with no difficulty; 1 = able to do with some difficulty; 2 = able to do with much difficulty; and 3 = unable to do. The final score range is 0–3. | Responses are 0 = able to do with no difficulty; 1 = able to do with some difficulty; 2 = able to do with much difficulty; and 3 = unable to do. The final score range is 0–3. | Responses are 0 = able to do with no difficulty; 1 = able to do with some difficulty; 2 = able to do with much difficulty; and 3 = unable to do. The final score range is 0–3. | Responses are 0 = able to do with no difficulty; 1 = able to do with some difficulty; 2 = able to do with much difficulty; and 3 = unable to do. The final score range is 0–3. |
| spondylarthropathies (HAQ-S)                                                                                                      | Response is defined as improvement in two factors (with at least one being a joint score) with worsening of none of the following four factors: • Patients global assessment (on a 0]5 Likert scale, improvement defined as decrease of 1 category, worsening defined as increase of 1 category)                                                                                                                                                                                | Response is defined as improvement in two factors (with at least one being a joint score) with worsening of none of the following four factors: • Patients global assessment (on a 0]5 Likert scale, improvement defined as decrease of 1 category, worsening defined as increase of 1 category)                                                                                                                                                                                | Response is defined as improvement in two factors (with at least one being a joint score) with worsening of none of the following four factors: • Patients global assessment (on a 0]5 Likert scale, improvement defined as decrease of 1 category, worsening defined as increase of 1 category)                                                                                                                                                                                | Response is defined as improvement in two factors (with at least one being a joint score) with worsening of none of the following four factors: • Patients global assessment (on a 0]5 Likert scale, improvement defined as decrease of 1 category, worsening defined as increase of 1 category)                                                                                                                                                                                |
| Physician Global Assessment                                                                                                       |                                                                                                                                                                                |                                                                                                                                                                                |                                                                                                                                                                                |                                                                                                                                                                                |
| Generalized Pustular Psoriasis Score (GPPPGA)                                                                                     | https://academic.oup.com/bjd/article/189/1/138/7131301                                                                                                                         | https://academic.oup.com/bjd/article/189/1/138/7131301                                                                                                                         | https://academic.oup.com/bjd/article/189/1/138/7131301                                                                                                                         | https://academic.oup.com/bjd/article/189/1/138/7131301                                                                                                                         |

## REFERENCES:

1. American College of Rheumatology references and treatment algorithms. http://www.rheumatology.org/Practice/Clinical/Guidelines/Clinical\_Practice\_Guidelines/
...
6. Singh, Jasvinder A., et al. "2015 American College of Rheumatology Guideline for the Treatment of Rheumatoid Arthritis."
8. Arthritis &amp; Rheumatology, vol. 68, no. 1, 2015, pp. 1–26.
